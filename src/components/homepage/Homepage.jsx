        ...
        <div className={styles.info}>
          <section className={styles.shopDesc}>
            <p className={styles.description}>
              ...
              wardrobe malfunctions here, just endless outfit combinations to
              keep your funky flag flying. Get ready to level up your style game
              and express yourself like a rockstar! We'll keep you stylin' with
              the latest trends without blowing your chill vibe.{" "}
